...
LABEL8:
	...
	add	qword [rbp-43*8], 16
	mov	r8, qword [rbp-43*8]
	mov	r9, qword [rbp-2*8]
	mov	qword [r8], r9
	; 31
LABEL9:
	mov	rax, qword [rbp-44*8]
	leave
	ret
FUNCTION_get:
	push	rbp
