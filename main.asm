...
FUNCTION_main:
	...
	add	qword [rbp-5*8], 16
	mov	qword [rbp-6*8], 20
	...
	add	qword [rbp-15*8], 32
	mov	qword [rbp-16*8], 40
...
LABEL0:
	...
	add	qword [rbp-17*8], 32
	mov	qword [rbp-18*8], 80
